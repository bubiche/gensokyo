...
# shellcheck source=cases/spellcards.sh
...
case $what in
  unit) core_tests; shrine_tests; hook_tests; telemetry_tests; recall_tests; spellcard_tests; install_tests; iterm_tests ;;
  smoke) smoke_tests ;;
  all) core_tests; shrine_tests; hook_tests; telemetry_tests; recall_tests; spellcard_tests; install_tests; iterm_tests; smoke_tests ;;
esac
